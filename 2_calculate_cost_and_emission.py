...
airports_df = pd.read_excel("out.xlsx")

for i, airport in airports_df.iterrows():
    costs = calc_costs(airport["Closest Refuelling Station Distance"], airport["LH2 to Replace 25% of Kerosene Mass:"])
...
airports_df.to_excel("out2.xlsx")
